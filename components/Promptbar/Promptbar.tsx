...
export const Promptbar: FC<Props> = ({
  ...
  return (
    <div
      className={`solidpixel--sidebar--right fixed top-0 right-0 z-50 flex h-full w-[260px] flex-none flex-col space-y-2 bg-[#202123] p-2 text-[14px] transition-all sm:relative sm:top-0`}
    >
      <div className="solidpixel--sidebar--right--inner flex items-center">
        <button
