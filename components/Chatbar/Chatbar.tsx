...
export const Chatbar: FC<Props> = ({
  ...
  return (
    <div
      className={`solidpixel--sidebar--left fixed top-0 bottom-0 z-50 flex h-full w-[260px] flex-none flex-col space-y-2 bg-zinc-900 p-2 transition-all sm:relative sm:top-0`}
    >
