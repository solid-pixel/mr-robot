...
export const ChatMessage: FC<Props> = memo(
  ({ message, messageIndex, onEditMessage }) => {
    ...
    return (
      <div
        className={`group mx-auto rounded-[15px] px-6 max-w-[950px] w-[calc(100%_-_50px)] ${
          message.role === 'assistant'
          ? 'rounded-tl-none rounded-tr-none border-b border-black/10 bg-gray-200 text-gray-800 dark:border-gray-900/50 dark:bg-zinc-700 dark:text-gray-100'
          : 'mt-6 rounded-bl-none rounded-br-none border-b border-black/10 bg-gray-50 text-gray-800 dark:border-gray-900/50 dark:bg-zinc-800  dark:text-gray-400'
        }`}
        style={{ overflowWrap: 'anywhere' }}
      >
        <div className="relative m-auto flex gap-4 p-4 text-base md:max-w-2xl md:gap-6 md:py-6 lg:max-w-2xl lg:px-0 xl:max-w-3xl">
          <div className="min-w-[40px] text-right font-bold solidpixel--sender">
