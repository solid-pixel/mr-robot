...
export const ChatInput: FC<Props> = ({
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent bg-gradient-to-b from-transparent via-white to-white pt-6 dark:border-white/20 dark:to-zinc-800 form:to-transparent md:pt-2">
