          ...
          <div className="flex h-full w-full pt-[48px] sm:pt-0">
            {showSidebar ? (
              <div>
                ...
                <button
                  className="solidpixel--sidebar--button fixed top-5 left-[270px] z-50 h-7 w-7 hover:text-gray-400 dark:text-white dark:hover:text-gray-300 sm:top-0.5 sm:left-[270px] sm:h-8 sm:w-8 sm:text-neutral-700"
            ...
            <div className="solidpixel--nodrag flex flex-1">
              <Chat
            ...
            {showPromptbar ? (
              <div>
                ...
                />
                <button
                  className="solidpixel--sidebar--button fixed top-5 right-[270px] z-50 h-7 w-7 hover:text-gray-400 dark:text-white dark:hover:text-gray-300 sm:top-0.5 sm:right-[270px] sm:h-8 sm:w-8 sm:text-neutral-700"
